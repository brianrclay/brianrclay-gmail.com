...
export default function Save(props) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" viewBox="0 0 16 16" {...props}>
      ...
      <path fill="#121417" fillRule="evenodd" d="M0 .5A.5.5 0 01.5 0h11a.5.5 0 01.354.146l4 4A.5.5 0 0116 4.5v11a.5.5 0 01-.5.5H.5a.5.5 0 01-.5-.5V.5zM1 1v14h14V4.707L11.293 1H1z" clipRule="evenodd" />
    </svg>
  );
}
